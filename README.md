...
1. Open the [v1.4 release](https://github.com/Cococolins/OTPilot/releases/tag/v1.4).
2. Download `OTPilot-v1.4-source.zip`.
3. Unzip the file.
4. Open the unzipped `OTPilot-v1.4` folder.
