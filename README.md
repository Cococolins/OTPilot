...
1. Open the [v1.3 release](https://github.com/Cococolins/OTPilot/releases/tag/v1.3).
2. Download `OTPilot-v1.3-source.zip`.
3. Unzip the file.
4. Open the unzipped `OTPilot-v1.3` folder.
